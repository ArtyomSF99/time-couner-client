...
export default function Workers() {
  ...
  const deleteWorker = async (id) => {
    await axios.delete(
      `https://work-couner-server.onrender.com/api/company-workers?worker_id=${id}`
    );
  };
  const createWorker = async (id) => {
    try {
      ...
      const response = await axios.post(
        "https://work-couner-server.onrender.com/api/company-workers",
        {
  ...
  const updateWorker = async (id) => {
    try {
      ...
      const response = await axios.put(
        "https://work-couner-server.onrender.com/api/company-roles",
        {
  ...
  const getWorkers = async () => {
    const response = await axios.get(
      `https://work-couner-server.onrender.com/api/company-workers?company_id=${company.id}`
    );
  ...
  const getRoles = async () => {
    const response = await axios.get(
      `https://work-couner-server.onrender.com/api/company-roles?company_id=${company.id}`
    );
    setWorkerRoles(response.data);
  };
  const getWorkerCode = async (id) => {
    const response = await axios.get(
      `https://work-couner-server.onrender.com/api/company-worker/code?worker_id=${id}`
    );
